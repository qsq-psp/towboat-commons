...
public class CombinationListTest {
    ...
    public void caseGet3Out5() {
        ...
        Assert.assertArrayEquals(new int[] {0, 1, 3}, list.get(1).toIntArray());
        Assert.assertArrayEquals(new int[] {0, 1, 4}, list.get(2).toIntArray());
        Assert.assertArrayEquals(new int[] {0, 2, 3}, list.get(3).toIntArray());
        Assert.assertArrayEquals(new int[] {0, 2, 4}, list.get(4).toIntArray());
        Assert.assertArrayEquals(new int[] {0, 3, 4}, list.get(5).toIntArray());
        Assert.assertArrayEquals(new int[] {1, 2, 3}, list.get(6).toIntArray());
    }

    @Test
    public void caseGet2Out6() {
        final CombinationList list = new CombinationList(6, 2);
        Assert.assertArrayEquals(new int[] {0, 5}, list.get(4).toIntArray());
        Assert.assertArrayEquals(new int[] {1, 2}, list.get(5).toIntArray());
        Assert.assertArrayEquals(new int[] {1, 3}, list.get(6).toIntArray());
        Assert.assertArrayEquals(new int[] {1, 4}, list.get(7).toIntArray());
        Assert.assertArrayEquals(new int[] {1, 5}, list.get(8).toIntArray());
        Assert.assertArrayEquals(new int[] {2, 3}, list.get(9).toIntArray());
    }

    @Test
    public void caseGet4Out7() {
        final CombinationList list = new CombinationList(7, 4);
        Assert.assertArrayEquals(new int[] {0, 1, 3, 4}, list.get(4).toIntArray());
        Assert.assertArrayEquals(new int[] {0, 1, 4, 5}, list.get(4 + 3).toIntArray());
        Assert.assertArrayEquals(new int[] {0, 1, 5, 6}, list.get(4 + 3 + 2).toIntArray());
        Assert.assertArrayEquals(new int[] {0, 2, 3, 4}, list.get(10).toIntArray()); // 10 = 4 + 3 + 2 + 1
        Assert.assertArrayEquals(new int[] {0, 3, 4, 5}, list.get(10 + 6).toIntArray());
        Assert.assertArrayEquals(new int[] {0, 4, 5, 6}, list.get(10 + 6 + 3).toIntArray());
        Assert.assertArrayEquals(new int[] {1, 2, 3, 4}, list.get(20).toIntArray()); // 20 = 10 + 6 + 3 + 1
        Assert.assertArrayEquals(new int[] {2, 3, 4, 5}, list.get(20 + 10).toIntArray());
        Assert.assertArrayEquals(new int[] {3, 4, 5, 6}, list.get(20 + 10 + 4).toIntArray());
    }
}
