...
public class PermutationListTest {
    ...
    public void caseGet3() {
        ...
        Assert.assertArrayEquals(new int[] {0, 1, 2}, list.get(0).toIntArray());
        Assert.assertArrayEquals(new int[] {0, 2, 1}, list.get(1).toIntArray());
        Assert.assertArrayEquals(new int[] {1, 0, 2}, list.get(2).toIntArray());
        Assert.assertArrayEquals(new int[] {2, 1, 0}, list.get(5).toIntArray());
    }

    @Test
    public void caseGet4() {
        final PermutationList list = new PermutationList(4);
        Assert.assertArrayEquals(new int[] {0, 1, 2, 3}, list.get(0).toIntArray());
        Assert.assertArrayEquals(new int[] {0, 1, 3, 2}, list.get(1).toIntArray());
        Assert.assertArrayEquals(new int[] {0, 3, 2, 1}, list.get(5).toIntArray());
        Assert.assertArrayEquals(new int[] {1, 0, 2, 3}, list.get(6).toIntArray());
        Assert.assertArrayEquals(new int[] {1, 0, 3, 2}, list.get(7).toIntArray());
        Assert.assertArrayEquals(new int[] {3, 2, 0, 1}, list.get(22).toIntArray());
        Assert.assertArrayEquals(new int[] {3, 2, 1, 0}, list.get(23).toIntArray());
    }

    @Test
    public void caseGet5() {
        final PermutationList list = new PermutationList(5);
        Assert.assertArrayEquals(new int[] {0, 1, 2, 3, 4}, list.get(0).toIntArray());
        Assert.assertArrayEquals(new int[] {0, 4, 3, 2, 1}, list.get(23).toIntArray());
        Assert.assertArrayEquals(new int[] {1, 0, 2, 3, 4}, list.get(24).toIntArray());
        Assert.assertArrayEquals(new int[] {2, 0, 1, 3, 4}, list.get(48).toIntArray());
        Assert.assertArrayEquals(new int[] {3, 0, 1, 2, 4}, list.get(72).toIntArray());
        Assert.assertArrayEquals(new int[] {4, 0, 1, 2, 3}, list.get(96).toIntArray());
        Assert.assertArrayEquals(new int[] {4, 3, 2, 1, 0}, list.get(119).toIntArray());
    }
        ...
        for (int n = 2; n <= MAX_N; n++) {
            ...
            try {
                ...
                for (int repeatIndex = 0; repeatIndex < repeatCount; repeatIndex++) {
                    ...
                    int[] array0 = list.get(index0).toIntArray();
                    int[] array1 = list.get(index1).toIntArray();
                    Assert.assertEquals(
    ...
    public void caseInverse4() {
        ...
        Assert.assertArrayEquals(new int[] {2, 0, 1, 3}, list.get(bigIndex).toIntArray());
        // case 6
        bigIndex = list.bigIndexOf(new PublicIntList(new int[] {1, 2, 3, 0}));
        Assert.assertNotNull(bigIndex);
        bigIndex = list.inverse(bigIndex);
        Assert.assertArrayEquals(new int[] {3, 0, 1, 2}, list.get(bigIndex).toIntArray());
    }
    ...
    public void caseInverse5() {
        ...
        Assert.assertNotNull(bigIndex);
        bigIndex = list.inverse(bigIndex);
        Assert.assertArrayEquals(new int[] {0, 3, 1, 2, 4}, list.get(bigIndex).toIntArray());
        // case 6
        bigIndex = list.bigIndexOf(new PublicIntList(new int[] {2, 3, 4, 0, 1}));
        Assert.assertNotNull(bigIndex);
        bigIndex = list.inverse(bigIndex);
        Assert.assertArrayEquals(new int[] {3, 4, 0, 1, 2}, list.get(bigIndex).toIntArray());
    }
}
