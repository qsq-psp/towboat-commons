...
public class ArrangementListTest {
    ...
    public void caseGet3out4() {
        ...
        Assert.assertArrayEquals(new int[] {0, 2, 1}, list.get(2).toIntArray());
        Assert.assertArrayEquals(new int[] {0, 2, 3}, list.get(3).toIntArray());
        Assert.assertArrayEquals(new int[] {0, 3, 1}, list.get(4).toIntArray());
        Assert.assertArrayEquals(new int[] {0, 3, 2}, list.get(5).toIntArray());
    }

    @Test
    public void caseGet3out5() {
        final ArrangementList list = new ArrangementList(5, 3);
        Assert.assertArrayEquals(new int[] {0, 4, 3}, list.get(11).toIntArray());
        Assert.assertArrayEquals(new int[] {1, 0, 2}, list.get(12).toIntArray());
        Assert.assertArrayEquals(new int[] {1, 0, 3}, list.get(13).toIntArray());
        Assert.assertArrayEquals(new int[] {1, 0, 4}, list.get(14).toIntArray());
        Assert.assertArrayEquals(new int[] {1, 2, 0}, list.get(15).toIntArray());
    }
