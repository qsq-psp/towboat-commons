...
@CodeHistory(date = "2025/3/5", name = "DataSizeStyleTest")
@CodeHistory(date = "2026/3/6")
public class DataSizeAppenderTest {

    private void caseInt(@NotNull DataSizeAppender style, int input, @NotNull String output) {
    ...
    private void caseLong(@NotNull DataSizeAppender style, long input, @NotNull String output) {
        Assert.assertFalse(style.isEmpty());
        Assert.assertEquals(output, style.stringify(input));
        Assert.assertEquals(output, style.stringify(BigInteger.valueOf(input)));
    }
    ...
    @Test
    public void caseDec() {
        final DataSizeAppender style = DataSizeAppender.createDec();
        caseInt(style, 0, "0");
        caseInt(style, 1, "1");
        caseInt(style, 9, "9");
        caseInt(style, 10, "10");
    ...
    public void caseHexLower() {
        final DataSizeAppender style = DataSizeAppender.createHex(false, false);
        caseInt(style, 0, "0x0");
        caseInt(style, 1, "0x1");
        caseInt(style, 2, "0x2");
    ...
    public void caseHexUpper() {
        final DataSizeAppender style = DataSizeAppender.createHex(true, false);
        caseInt(style, 0, "0x0");
        caseInt(style, 1, "0x1");
        caseInt(style, 4, "0x4");
        caseInt(style, 7, "0x7");
    ...
    public void caseHexPadding() {
        final DataSizeAppender style = DataSizeAppender.createHex(false, true);
    ...
    public void case1000M0() {
        final DataSizeAppender style = DataSizeAppender.create1000(0);
    ...
    public void case1000M1() {
        final DataSizeAppender style = DataSizeAppender.create1000(1);
        Assert.assertEquals("0 byte(s)", style.stringify(0));
        Assert.assertEquals("1 byte(s)", style.stringify(1));
        Assert.assertEquals("999 byte(s)", style.stringify(999));
    ...
    public void case1000M2() {
        final DataSizeAppender style = DataSizeAppender.create1000(2);
        Assert.assertEquals("0 byte(s)", style.stringify(0));
    ...
    public void case1000M3() {
        final DataSizeAppender style = DataSizeAppender.create1000(3);
    ...
    public void case1024M0() {
        final DataSizeAppender style = DataSizeAppender.create1024(0);
        Assert.assertEquals("0 byte(s)", style.stringify(0));
        Assert.assertEquals("1 byte(s)", style.stringify(1));
