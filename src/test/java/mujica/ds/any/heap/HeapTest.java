...
public class HeapTest {
    ...
    private void checkSerialization(@NotNull Supplier<PriorityQueue<String>> supplier) {
        final Map<String, S32> map = new HashMap<>();
        for (int repeatIndex = 0; repeatIndex < REPEAT; repeatIndex++) {
            ...
            try {
                ...
                while (true) {
                    ...
                    S32.decrease(map, element);
                }
                for (S32 slot : map.values()) {
                    Assert.assertEquals(0, slot.getI32());
                }
    ...
    private void checkPoll(@NotNull Supplier<Queue<String>> supplier) {
        ...
        for (int repeatIndex = 0; repeatIndex < REPEAT; repeatIndex++) {
            ...
            try {
                ...
                for (S32 slot : map.values()) {
                    Assert.assertEquals(0, Math.max(0, slot.getI32())); // assert slot.getI32() <= 0
                }
            } catch (AssertionError e) {
                System.out.println(map);
                System.out.println(queue);
        ...
        for (int repeatIndex = 0; repeatIndex < REPEAT; repeatIndex++) {
            ...
            try {
                ...
                }
                {
                    ...
                    for (int index = 0; index < size; index++) {
                        S32.decrease(map, iterator.next());
                    }
                    iterator.remove();
