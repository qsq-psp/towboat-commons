...
@CodeHistory(date = "2025/10/6", name = "DeflateCodecTest") // just InflateTest
public class DeflateCodecTest {
    ...
    @NotNull
    private LookBackMemory nextRunBuffer(int maxDistance) {
        switch (fc.nextInt(4)) {
            case 0:
                return new CyclicLookBackMemory(maxDistance);
            case 1:
                return new CyclicLookBackMemory(maxDistance, nextRunBufferResizePolicy());
            case 2:
                return new ArrayCopyLookBackMemory(maxDistance);
            case 3:
                return new BlockLookBackMemory(maxDistance, fc.nextInt(2, 20));
            default:
                throw new IllegalStateException();
        }
    }
    ...
    @NotNull
    private LookBackMemory nextRunBuffer() {
