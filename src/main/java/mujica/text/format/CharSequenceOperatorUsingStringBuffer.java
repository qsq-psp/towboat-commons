...
public class CharSequenceOperatorUsingStringBuffer implements CharSequenceOperator {
    ...
    public CharSequenceOperatorUsingStringBuffer(@NotNull CharSequenceAppender appender) {
        super();
