...
@DirectSubclass({StructureCheckAdapter.class, CacheAdapter.class, UndoKeyJsonHandlerAdapter.class, EarlyKeyCheckAdapter.class})
public class JsonHandlerAdapter<H extends JsonHandler> extends JsonHandler {
    ...
    public boolean structureChecked() {
        return h.structureChecked();
    }

    @Override
    public boolean duplicateKeyChecked() {
        return h.duplicateKeyChecked();
    }

    @Override
    public boolean supportsUndoKey() {
        return h.supportsUndoKey();
    }

    @Override
    public int typePreference() {
        return h.typePreference();
    }
