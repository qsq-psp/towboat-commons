...
public class FuzzyStringContext extends FuzzyContext {
    ...
    public char nextChar() {
        switch ((int) source.applyAsLong(4)) { // from 0x0 to 0xf
            ...
            case 0x1:
            case 0x2:
                return (char) source.applyAsLong(7); // ASCII
            case 0x3:
            case 0x4:
                return (char) source.applyAsLong(8);
            case 0x5:
            case 0x6:
            case 0x7:
            case 0x8:
            ...
            case 0xa:
                return (char) (Character.MIN_SURROGATE + source.applyAsLong(11)); // Surrogate
            default:
                return (char) source.applyAsLong(16);
        }
    }
