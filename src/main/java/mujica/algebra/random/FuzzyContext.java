...
public class FuzzyContext extends FreeFloatingPointContext {
    ...
    public byte nextByte() {
        switch ((int) source.applyAsLong(4)) { // from 0x0 to 0xf
            ...
            case 0xc:
                return (byte) 0xfe;
            case 0xd:
                return (byte) (1 << source.applyAsLong(3));
            case 0xe:
                return (byte) ((1 << source.applyAsLong(3)) - 1);
            case 0xf:
    ...
    public short nextShort() {
        switch ((int) source.applyAsLong(4)) { // from 0x0 to 0xf
            ...
            case 0x9:
                return (short) (1 << source.applyAsLong(4));
            case 0xa:
                return (short) ((1 << source.applyAsLong(4)) - 1);
            case 0xb:
    ...
    private int specialInt() {
        ...
        switch ((int) source.applyAsLong(4)) { // from 0x0 to 0xf
            ...
            case 0x6:
                return Integer.rotateRight(value, (int) source.applyAsLong(5));
            default: // 9 values
                return value;
        }
    }
    ...
    public int nextInt() {
        switch ((int) source.applyAsLong(4)) { // from 0x00 to 0x1f
            ...
            case 0x09:
                return 1 << source.applyAsLong(5);
            case 0x0a:
                return ~(1 << source.applyAsLong(5));
            case 0x0b:
                return -(1 << source.applyAsLong(5));
            case 0x0c:
                return (1 << source.applyAsLong(5)) - 1;
            case 0x0d:
                return -1 << source.applyAsLong(5);
            case 0x0e:
    ...
    private long specialLong() {
        ...
        switch ((int) source.applyAsLong(4)) { // from 0x0 to 0xf
            ...
            case 0x6:
                return Long.rotateLeft(value, (int) source.applyAsLong(6));
            default: // 9 values
                return value;
        }
    }
    ...
    public long nextLong() {
        switch ((int) source.applyAsLong(5)) { // from 0x00 to 0x1f
            ...
            case 0x09:
                return 1L << source.applyAsLong(6);
            case 0x0a:
                return ~(1L << source.applyAsLong(6));
            case 0x0b:
                return -(1L << source.applyAsLong(6));
            case 0x0c:
                return (1L << source.applyAsLong(6)) - 1L;
            case 0x0d:
                return -1L << source.applyAsLong(6);
            case 0x0e:
    ...
    protected long nextFloatBits() {
        switch ((int) source.applyAsLong(2)) { // from 0x0 to 0x3
            case 0x0:
