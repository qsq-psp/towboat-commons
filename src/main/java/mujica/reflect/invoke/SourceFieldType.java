...
public class SourceFieldType implements NotLoadedFieldType<SourceFieldType>, Serializable {
    ...
    @ReferencePage(title = "JVMS12 Chapter 4. The class File Format", author = "James Gosling", language = "en", href = "https://docs.oracle.com/javase/specs/jvms/se12/html/jvms-4.html#jvms-4.3")
