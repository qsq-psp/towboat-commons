...
public class BitNotLongQueue implements OrderedLongQueue {

    @NotNull
    private final OrderedLongQueue queue;

    public BitNotLongQueue(@NotNull OrderedLongQueue queue) {
        super();
        this.queue = queue;
    }
    ...
    public OrderedLongQueue duplicate() {
        return new BitNotLongQueue(queue.duplicate());
    }
    ...
    public Iterator<Long> iterator() {
        ...
        if (it instanceof PrimitiveIterator.OfLong) {
            PrimitiveIterator.OfLong lit = (PrimitiveIterator.OfLong) it;
