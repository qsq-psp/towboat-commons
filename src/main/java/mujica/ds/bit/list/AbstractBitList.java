...
@CodeHistory(date = "2026/3/12", name = "AbstractBooleanList")
...
public abstract class AbstractBitList implements BitList {
    ...
    protected AbstractBitList() {
        super();
    }

    @NotNull
    @Override
    public abstract AbstractBitList duplicate();
    ...
    @Override
    public boolean equals(@NotNull BitList that) {
    ...
    public boolean equals(Object o) {
        return this == o || o instanceof BitList && this.equals((BitList) o);
    }
