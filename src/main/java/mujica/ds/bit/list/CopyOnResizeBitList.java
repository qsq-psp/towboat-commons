...
@CodeHistory(date = "2026/3/13", name = "CopyOnResizeBooleanList")
@CodeHistory(date = "2026/6/24")
public class CopyOnResizeBitList extends AbstractBitList {
    ...
    @NotNull
    @Override
    public CopyOnResizeBitList duplicate() {
        return new CopyOnResizeBitList(policy, Arrays.copyOf(array, endIndex));
    }
