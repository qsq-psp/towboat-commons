...
public class IntAscendingBucketSort extends SortingAlgorithm<int[]> {
    ...
    public IntAscendingBucketSort(@NotNull SortingAlgorithm<int[]> next, int start, int step, int bucketCount) {
        super();
    ...
    public long sort(@NotNull int[] array, int startIndex, int endIndex) {
        ...
        for (int index = startIndex; index < endIndex; index++) {
            ...
            buckets[bucketIndex].offerLast(value);
        }
