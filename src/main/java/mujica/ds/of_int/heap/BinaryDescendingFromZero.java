...
@CodeHistory(date = "2024/1/15", project = "Ultramarine", name = "IntHeap.MaxS0")
@CodeHistory(date = "2026/1/10")
public class BinaryDescendingFromZero extends ArrayIntHeap {
    ...
    @NotNull
    @Override
    public BinaryDescendingFromZero duplicate() {
        final BinaryDescendingFromZero that = new BinaryDescendingFromZero(
