...
public class LookUpIntMap extends IterableIntMap {
    ...
    public LookUpIntMap(@NotNull IntList primary, @NotNull IterableIntMap secondary) {
        super();
        this.primary = primary;
        this.secondary = secondary;
    }

    public LookUpIntMap(@NotNull IntList primary) {
        this(primary, new CompatibleIntMap());
    }


    public LookUpIntMap(@NotNull int[] array) {
        this(new PublicIntList(array));
    }

    public LookUpIntMap(int length) {
    ...
    @NotNull
    @Override
    public LookUpIntMap clone() {
        return duplicate();
    }

    @NotNull
    @Override
    public LookUpIntMap duplicate() {
        return new LookUpIntMap(primary.duplicate(), secondary.duplicate());
    }
