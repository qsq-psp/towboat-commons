...
public class JdkNavigableS32Map extends NavigableS32Map {

    @NotNull
    private final NavigableMap<Integer, Integer> map;

    public JdkNavigableS32Map(@NotNull NavigableMap<Integer, Integer> map) {
        super();
        this.map = map;
    }

    public JdkNavigableS32Map() {
        this(new TreeMap<>());
    }
    ...
    @Override
    @NotNull
    protected JdkNavigableS32Map clone() {
        return duplicate();
    }

    @NotNull
    @Override
    public JdkNavigableS32Map duplicate() {
        return new JdkNavigableS32Map(new TreeMap<>(map));
    }
    ...
    public boolean equals(Object obj) {
        return obj instanceof JdkNavigableS32Map && this.map.equals(((JdkNavigableS32Map) obj).map);
    }
