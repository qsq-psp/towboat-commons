...
public class ModuloLookUpCapacityPolicy extends LookUpCapacityPolicy {

    private static final long serialVersionUID = 0x1bf5a339f6be2cbaL;

    protected ModuloLookUpCapacityPolicy(@NotNull int[] array, boolean isPrime, boolean isQuadraticFull) {
        super(array, isPrime, isQuadraticFull);
    }

    protected ModuloLookUpCapacityPolicy(@NotNull int[] array) {
        super(array);
    }
    ...
    public static final ModuloLookUpCapacityPolicy INSTANCE_59 = new ModuloLookUpCapacityPolicy(A_59, false, true);
    ...
    public static final ModuloLookUpCapacityPolicy INSTANCE_67 = new ModuloLookUpCapacityPolicy(A_67, false, true);
}
