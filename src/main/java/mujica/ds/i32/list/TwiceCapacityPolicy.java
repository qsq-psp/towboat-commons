...
public class TwiceCapacityPolicy extends CapacityPolicy {

    private static final long serialVersionUID = 0x1872490f58fd75e0L;

    public static final TwiceCapacityPolicy INSTANCE = new TwiceCapacityPolicy(15);

    private final int initial;

    public TwiceCapacityPolicy(int initial) {
        super();
        if (initial <= 0) {
    ...
    public TwiceCapacityPolicy(@NotNull RandomContext rc) {
