...
public class LookUpCapacityPolicy extends CapacityPolicy {
    ...
    protected LookUpCapacityPolicy(@NotNull int[] array, boolean isPrime, boolean isQuadraticFull) {
        super();
        this.array = array;
    ...
    protected LookUpCapacityPolicy(@NotNull int[] array) {
    ...
    @NotNull
    public static LookUpCapacityPolicy geometric(double initial, double multiplier) {
        if (!(multiplier > 1.0)) {
            throw new IllegalArgumentException();
        }
        ...
        return new LookUpCapacityPolicy(intList.toIntArray());
    }

    public static final CapacityPolicy PAPER = geometric(3.0, Math.sqrt(2.0)); // 1.414...

    public static final CapacityPolicy GOLDEN = geometric(Math.sqrt(10.0), 0.5 * (1.0 + Math.sqrt(5.0))); // 1.618...

    public static final CapacityPolicy NATURAL = geometric(20.0, Math.E); // 2.71828...
    ...
    public static final CapacityPolicy PRIME_PAPER = new LookUpCapacityPolicy(PRIME_PAPER_INTERNAL_DATA, true, false);
    ...
    public static final CapacityPolicy PRIME_GOLDEN = new LookUpCapacityPolicy(PRIME_GOLDEN_INTERNAL_DATA, true, false);
    ...
    public static final CapacityPolicy PRIME_FIBONACCI = new LookUpCapacityPolicy(PRIME_FIBONACCI_INTERNAL_DATA, true, false);
}
