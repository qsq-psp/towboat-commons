...
@CodeHistory(date = "2025/12/23", name = "IntDescendingQuickSort")
@CodeHistory(date = "2026/7/14")
@Name(value = "32位有符号整数递减快速排序", language = "zh")
public class S32DescendingQuickSort implements Sort<int[]> {
    ...
    public S32DescendingQuickSort(@NotNull SelectPivot<I32, int[]> selectPivot) {
        super();
