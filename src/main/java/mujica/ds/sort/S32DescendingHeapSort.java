...
@CodeHistory(date = "2025/11/10", name = "IntDescendingHeapSort")
@CodeHistory(date = "2026/7/19")
@Name(value = "32位有符号整数递增堆排序", language = "zh")
public class S32DescendingHeapSort implements Sort<int[]> {

    public static final S32DescendingHeapSort INSTANCE = new S32DescendingHeapSort();

    public S32DescendingHeapSort() {
        super();
    }
