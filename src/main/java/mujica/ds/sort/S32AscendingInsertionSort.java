...
@CodeHistory(date = "2025/10/30", name = "IntAscendingInsertionSort")
@CodeHistory(date = "2026/7/20")
@Name(value = "32位有符号整数递增插入排序", language = "zh")
public class S32AscendingInsertionSort implements Sort<int[]> {

    public static final S32AscendingInsertionSort INSTANCE = new S32AscendingInsertionSort();

    public S32AscendingInsertionSort() {
        super();
    }
