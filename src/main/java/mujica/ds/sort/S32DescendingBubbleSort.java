...
@CodeHistory(date = "2025/10/25", name = "IntDescendingBubbleSort")
@CodeHistory(date = "2026/7/16")
@Name(value = "32位有符号整数递减冒泡排序", language = "zh")
public class S32DescendingBubbleSort implements Sort<int[]> {

    public static final S32DescendingBubbleSort INSTANCE = new S32DescendingBubbleSort();

    public S32DescendingBubbleSort() {
        super();
    }
