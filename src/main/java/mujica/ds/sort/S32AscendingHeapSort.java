...
@CodeHistory(date = "2025/11/9", name = "IntAscendingHeapSort")
@CodeHistory(date = "2026/7/19")
@Name(value = "32位有符号整数递增堆排序", language = "zh")
public class S32AscendingHeapSort implements Sort<int[]> {

    public static final S32AscendingHeapSort INSTANCE = new S32AscendingHeapSort();

    public S32AscendingHeapSort() {
        super();
    }
